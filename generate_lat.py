...
class AutoEncoder(nn.Module):
    ...
    def forward(self, x):
        ...
        # reshape = upsample.view(-1, 16, 16, 16) # loss to conv4
...
for num in range(len(images_dir)):
	...
	save_image(make_grid(pic, nrow=5), './result/{}.png'.format(num))


pickle.dump(lat_pkl, open("lat.pkl", "wb"))
